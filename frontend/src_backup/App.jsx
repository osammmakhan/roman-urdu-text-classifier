          ...
          {result === null && !loading && (
            <div className="fade-in">
              <div className="mt-2 p-2 bg-gray-100 rounded text-sm text-gray-600">
                Enter text above to see classification results here
              </div>
            </div>
          )}
        </div>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {results.map((item, index) => (
                    <tr key={item.id} className="border-b border-gray-100 hover:bg-gray-50" style={{ transitionDelay: `${index * 30}ms` }}>
